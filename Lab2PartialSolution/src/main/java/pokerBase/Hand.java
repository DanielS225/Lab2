...
public class Hand {
	...
	private static boolean isHandFlush(ArrayList<Card> cards) {
		...
		if ((cards.get(eCardNo.FirstCard.getCardNo()).geteSuit() == cards.get(eCardNo.SecondCard.getCardNo())
				.geteSuit())
				&& (cards.get(eCardNo.FirstCard.getCardNo()).geteSuit() == cards.get(eCardNo.ThirdCard.getCardNo())
						.geteSuit())
				&& (cards.get(eCardNo.FirstCard.getCardNo()).geteSuit() == cards.get(eCardNo.FourthCard.getCardNo())
						.geteSuit())
				&& (cards.get(eCardNo.FirstCard.getCardNo()).geteSuit() == cards.get(eCardNo.FifthCard.getCardNo())
						.geteSuit())) {
	...
	private static boolean isHandStraight(ArrayList<Card> cards) {
		...
		if ((((cards.get(eCardNo.FirstCard.getCardNo()).geteRank()).getiRankNbr() - 1) == cards
				.get(eCardNo.SecondCard.getCardNo()).geteRank().getiRankNbr())
				&& (((cards.get(eCardNo.SecondCard.getCardNo()).geteRank()).getiRankNbr() - 1) == cards
						.get(eCardNo.ThirdCard.getCardNo()).geteRank().getiRankNbr())
				&& (((cards.get(eCardNo.ThirdCard.getCardNo()).geteRank()).getiRankNbr() - 1) == cards
						.get(eCardNo.FourthCard.getCardNo()).geteRank().getiRankNbr())
				&& (((cards.get(eCardNo.FourthCard.getCardNo()).geteRank()).getiRankNbr() - 1) == cards
	...
	public static boolean isHandThreeOfAKind(Hand h, HandScore hs) {
		...
		if (h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank() == h.getCardsInHand()// first three of a kind
				.get(eCardNo.ThirdCard.getCardNo()).geteRank()) {// kickers are
																	// last two
			isThreeOfAKind = true;
			...
			hs.setKickers(kickers);
				...
				.get(eCardNo.FourthCard.getCardNo()).geteRank()) {// kickers are
																	// first and
																	// last
			isThreeOfAKind = true;
			hs.setHandStrength(eHandStrength.ThreeOfAKind.getHandStrength());
	...
	public static boolean isHandTwoPair(Hand h, HandScore hs) {
		...
		if ((h.getCardsInHand().get(eCardNo.FirstCard.getCardNo()).geteRank() == h.getCardsInHand()// first
																									// two
																									// pairs
				.get(eCardNo.SecondCard.getCardNo()).geteRank())
				&& (h.getCardsInHand().get(eCardNo.ThirdCard.getCardNo()).geteRank() == h.getCardsInHand()
						.get(eCardNo.FourthCard.getCardNo()).geteRank())) {// kicker
																			// at
																			// end
			isTwoPair = true;
			...
			hs.setKickers(kickers);
				...
				.get(eCardNo.SecondCard.getCardNo()).geteRank())
				&& (h.getCardsInHand().get(eCardNo.FourthCard.getCardNo()).geteRank() == h.getCardsInHand()
						.get(eCardNo.FifthCard.getCardNo()).geteRank())) {// kicker
																			// in
																			// middle
			isTwoPair = true;
			hs.setHandStrength(eHandStrength.TwoPair.getHandStrength());
			...
			hs.setKickers(kickers);
				...
				.get(eCardNo.ThirdCard.getCardNo()).geteRank())
				&& (h.getCardsInHand().get(eCardNo.FourthCard.getCardNo()).geteRank() == h.getCardsInHand()
						.get(eCardNo.FifthCard.getCardNo()).geteRank())) {// kicker at end
			isTwoPair = true;
			hs.setHandStrength(eHandStrength.TwoPair.getHandStrength());
